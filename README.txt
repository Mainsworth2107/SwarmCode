...
beeFit: Returns the fitness of a potential solution based on the method proposed by Jetvić et al.

beeNew: Applies the new swapping and mutation behaviours for exploring the problem space.
...
greedy.m: Function that handles greedy initialisation of ABC solutions
...
robots.mat Saved robots configuration for testing functions without the impact of randomness.

shiftSol.m Function that implements the legacy one point swap behaviour for testing purposes.

updateSol.m Function that greedily decided between the original or potential solution, and bring the best forwards
